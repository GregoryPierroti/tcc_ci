...
4. Observar o primeiro detector na CI e executar validação integral quando a CI passar.
...
- Falsos negativos são confirmados por validação independente de dados.
