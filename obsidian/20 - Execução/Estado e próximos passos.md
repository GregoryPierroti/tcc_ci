...
> A rodada v2 foi revalidada após V2-SP-002. Há 18 execuções v2 registradas,
> correspondentes a 16 mutações únicas: 13 detectadas, 4 falsos negativos e
...
| Rodada v2 (parcial) | 16 de 28 mutações únicas concluídas; 12 restantes | `results/resultados.csv`, `fault-catalog/falhas-v2.yml` |
...
2. Executar as 12 mutações restantes de forma isolada a partir da baseline
   reconstruída e
   ...
   detectada por Ruff F821; V2-SP-002 foi detectada por mypy. A próxima é
   V2-SP-003, de comportamento unitário Spark.
