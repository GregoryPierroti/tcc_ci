...
| PySpark | 5 | 3 | 2 | 60% | 54,0 s | complementar: runtime Spark/Java/JDBC e validações integrais fora da CI basal. |
...
dois casos PySpark aprovados pela CI e revelados depois pela validação integral
