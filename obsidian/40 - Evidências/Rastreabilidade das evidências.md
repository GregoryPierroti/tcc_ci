...
2. Cada execução do CSV tem identificador, baseline, commit da mutação,
   duração, desfecho e URL do job. A v1 possui 15 execuções, cinco por
   tecnologia; a v2 será adicionada sob baseline distinta.
...
Use esta nota para recuperar uma afirmação da [[Matriz comparativa final|matriz v1]] até
